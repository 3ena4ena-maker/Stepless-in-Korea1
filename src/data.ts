...
const UNSORTED_STATIONS: Station[] = [
  {
    id: 'seomyeon',
    recommendedExits: "7번, 11번, 12번, 13번 출구 (엘리베이터) / 5번, 9번, 10번, 11번, 13번 출구 (에스컬레이터)",
    recommendedExitsEn: "Exits 7, 11, 12, 13 (Elevators) / Exits 5, 9, 10, 11, 13 (Escalators)",
    elevatorLocationDesc: "7번, 11번, 12번, 13번 출구 지상 수직 엘리베이터 (롯데백화점, 영광도서, 대현프리몰, 부전시장 방면)",
    elevatorLocationDescEn: "Ground elevators operating at Exits 7, 11, 12, and 13 (Lotte Dept Store, Yeonggwang Bookstore, Daehyeon Free Mall, Bujeon Market).",
    ...
    exits: [
      ...
      },
      {
        ...
        status: 'OPERATIONAL',
        directionDesc: '대현프리몰 지하상가, 신한은행 금융골목 방면',
        directionDescEn: 'Daehyeon Free Mall Underground Shopping, Shinhan Bank Financial Alley',
        latitude: 35.158892,
      ...
      },
      {
        ...
        status: 'OPERATIONAL',
        directionDesc: '신한은행 서면지점, 부전시장 방면',
        directionDescEn: 'Shinhan Bank Seomyeon Branch, Bujeon Market',
        latitude: 35.158377,
  ...
  {
    id: 'jeonpo',
    recommendedExits: "3번, 4번 출구 (엘리베이터) / 7번, 8번 출구 (에스컬레이터)",
    recommendedExitsEn: "Exits 3, 4 (Elevators) / Exits 7, 8 (Escalators)",
    elevatorLocationDesc: "3번 및 4번 출구 사이 지상 수직 엘리베이터 (부산진소방서, 경남공고 방면)",
    elevatorLocationDescEn: "Ground elevator between Exits 3 & 4 (Toward Busanjin Fire Station & Gyeongnam High School)",
  ...
  {
    id: 'bujeon',
    recommendedExits: "3번, 6번 출구 (엘리베이터) / 부전몰 3번, 5번 출구 (에스컬레이터)",
    recommendedExitsEn: "Exits 3, 6 (Elevators) / Bujeon Mall Exits 3, 5 (Escalators)",
    elevatorLocationDesc: "3번 출구 및 6번 출구(코레일 부전역 환승) 지상 수직 엘리베이터",
    elevatorLocationDescEn: "Ground elevators at Exit 3 & Exit 6 (Direct access to Korail Bujeon Train Station)",
  ...
  {
    id: 'haeundae',
    recommendedExits: "2번, 4번, 5번, 7번 출구 (지상 수직 엘리베이터)",
    recommendedExitsEn: "Exits 2, 4, 5, 7 (Elevators)",
    elevatorLocationDesc: "2·4번 출구 사이(우동 방면) 및 5·7번 출구 사이(구남로 해수욕장 광장 방면) 지상 엘리베이터",
    elevatorLocationDescEn: "Ground elevators at Exits 2 & 4 (U-dong) and Exits 5 & 7 (Gunam-ro Beach Plaza)",
  ...
  {
    id: 'gwangan',
    recommendedExits: "5번, 6번 출구 (엘리베이터)",
    recommendedExitsEn: "Exits 5 & 6 (Elevators)",
    elevatorLocationDesc: "5번 출구(광안리 해수욕장 방면) 및 6번 출구 지상 수직 엘리베이터",
    elevatorLocationDescEn: "Ground elevators operating at Exit 5 (Toward Beach) & Exit 6",
    avgMovementTime: "도보 약 2분",
    avgMovementTimeEn: "Approx. 2 mins walk",
  ...
  {
    id: 'nampo',
    recommendedExits: "4번, 8번, 10번 출구 (엘리베이터) / 2번, 6번, 7번 출구 (에스컬레이터)",
    recommendedExitsEn: "Exits 4, 8, 10 (Elevators) / Exits 2, 6, 7 (Escalators)",
    elevatorLocationDesc: "4번 출구(영도대교 방면) 및 8·10번 출구(롯데백화점 광복점 직결) 지상 엘리베이터",
    elevatorLocationDescEn: "Ground elevators at Exit 4 (Yeongdo Bridge) & Exits 8, 10 (Connected to Lotte Dept. Store)",
    avgMovementTime: "도보 약 2분",
    avgMovementTimeEn: "Approx. 2 mins walk",
  ...
  {
    id: 'busan',
    recommendedExits: "4번, 5번 출구 (엘리베이터) / 6번, 7번 출구 (에스컬레이터)",
    recommendedExitsEn: "Exits 4, 5 (Elevators) / Exits 6, 7 (Escalators)",
    elevatorLocationDesc: "4번 출구 및 5번 출구 지상 수직 엘리베이터 (6번 출구 상하행 에스컬레이터)",
    elevatorLocationDescEn: "Ground elevators operating at Exits 4 & 5 (Escalators at Exit 6)",
  ...
  {
    id: 'suyeong',
    recommendedExits: "1번, 10번, 11번 출구 (엘리베이터) / 15번 출구 (에스컬레이터)",
    recommendedExitsEn: "Exits 1, 10, 11 (Elevators) / Exit 15 (Escalators)",
    elevatorLocationDesc: "1번, 10번, 11번 출구 지상 수직 엘리베이터",
    elevatorLocationDescEn: "Ground elevators operating at Exits 1, 10, and 11",
  ...
  {
    id: 'jagalchi',
    recommendedExits: "3번, 6번 출구 (엘리베이터) / 10번 출구, 지하상가 6번, 7번 출구 (에스컬레이터)",
    recommendedExitsEn: "Exits 3, 6 (Elevators) / Exit 10 & Underground Mall Exits 6, 7 (Escalators)",
    elevatorLocationDesc: "3번 출구(부평깡통시장 방면) 및 6번 출구 지상 수직 엘리베이터",
    elevatorLocationDescEn: "Ground elevators operating at Exit 3 (Toward Bupyeong Market) & Exit 6",
    avgMovementTime: "도보 약 2분",
    avgMovementTimeEn: "Approx. 2 mins walk",
  ...
  {
    id: 'geumnyeonsan',
    recommendedExits: "3번, 4번 출구 (엘리베이터)",
    recommendedExitsEn: "Exits 3 & 4 (Elevators)",
    elevatorLocationDesc: "3번 출구(광안리, 수영구청 방면) 및 4번 출구 지상 수직 엘리베이터",
    elevatorLocationDescEn: "Ground elevators operating at Exit 3 (Toward Beach & District Office) & Exit 4",
    avgMovementTime: "도보 약 1.5분",
    avgMovementTimeEn: "Approx. 1.5 mins walk",
  ...
  {
    id: 'dongbaek',
    recommendedExits: "4번 출구 (엘리베이터)",
    recommendedExitsEn: "Exit 4 (Elevator)",
    elevatorLocationDesc: "4번 출구 지상 전용 수직 엘리베이터 (마린시티, 동백섬 방면)",
    elevatorLocationDescEn: "Ground-level elevator at Exit 4 (Toward Marine City & Dongbaekseom)",
    avgMovementTime: "도보 약 1.5분",
    avgMovementTimeEn: "Approx. 1.5 mins walk",
  ...
  {
    id: 'bexco',
    recommendedExits: "6번, 7번 출구, 2·4번 출구 사이, 9·11번 출구 사이 (엘리베이터)",
    recommendedExitsEn: "Exits 6, 7 & Between Exits 2-4, 9-11 (Elevators)",
    elevatorLocationDesc: "6번, 7번 출구 및 2·4번, 9·11번 출구 사이 지상 엘리베이터 (벡스코, 시립미술관 연결)",
    elevatorLocationDescEn: "Ground elevators at Exits 6, 7 and between Exits 2-4, 9-11 (Connected to BEXCO & Museum of Art)",
  ...
  },
  {
    ...
    transferRouteDesc: '지하 2층 승강장 수직 엘리베이터 ↔ 지하 1층 대합실 무단차 이동 ↔ 8번·12번·13번 출구 지상 엘리베이터 (중앙동 지하상가 수평 연결)',
    transferRouteDescEn: 'Platform (B2F) Elevator ↔ Concourse (B1F) Level Access ↔ Direct Street Elevators at Exits 8, 12, 13 (Step-free underground mall connection)',
  ...
  },
  {
    ...
    transferRouteDesc: '지하 2층 승강장 수직 엘리베이터/에스컬레이터 ↔ 지하 1층 대합실 개찰구 ↔ 2번·3번·4번 출구 지상 수직 엘리베이터 (다대포 해변공원 평지 연결)',
    transferRouteDescEn: 'Platform (B2F) Elevator/Escalator ↔ Concourse (B1F) Gate ↔ Ground Elevators at Exits 2, 3, 4 (Direct level connection to Dadaepo Beach Park)',
  ...
  },
  {
    ...
    transferRouteDesc: '지하 2층 승강장 내 수직 승강기 ↔ 지하 1층 대합실 개찰구 ↔ 3번·4번 출구 지상 수직 엘리베이터 (범어사 환승정류장 버스 연계 동선)',
    transferRouteDescEn: 'Platform (B2F) Elevator ↔ Concourse (B1F) Gate ↔ Ground Elevators at Exits 3 & 4 (Direct step-free route to Beomeosa Bus Transfer Stop)',
