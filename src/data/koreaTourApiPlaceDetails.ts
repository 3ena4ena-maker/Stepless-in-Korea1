...
export const KOREA_TOUR_API_PLACE_DETAILS: Record<string, OpenApiPlaceDetail> = {
  ...
  'spot-101': {
    ...
    firstImage: 'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=1200&q=85',
    additionalImages: [
  ...
  'spot-aquarium': {
    ...
    districtKo: '해운대구',
    districtEn: 'Haeundae-gu',
    firstImage: 'https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=1200&q=85',
    additionalImages: [
  ...
  'spot-xthesky': {
    ...
    districtKo: '해운대구',
    districtEn: 'Haeundae-gu',
    firstImage: 'https://images.unsplash.com/photo-1506744038136-46273834b3fb?auto=format&fit=crop&w=1200&q=85',
    additionalImages: [
  ...
  'spot-106': {
    ...
    districtKo: '사하구',
    districtEn: 'Saha-gu',
    firstImage: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1200&q=85',
    additionalImages: [
  ...
  'spot-bupyeong-market': {
    ...
    districtKo: '중구',
    districtEn: 'Jung-gu',
    firstImage: 'https://images.unsplash.com/photo-1538485399081-7191377e8241?auto=format&fit=crop&w=1200&q=85',
    additionalImages: [
      'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&w=800&q=80',
    ],
  ...
  'spot-city-tour-bus': {
    ...
    districtKo: '동구',
    districtEn: 'Dong-gu',
    firstImage: 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&w=1200&q=85',
    additionalImages: [
      'https://images.unsplash.com/photo-1519046904884-53103b34b206?auto=format&fit=crop&w=800&q=80',
      'https://images.unsplash.com/photo-1540959733332-eab4deabeeaf?auto=format&fit=crop&w=800&q=80',
    ],
